...
| [**videowall**](demos/videowall/) | A control-room **video wall**: one superwide canvas with many sources (cameras, RTSP/RTMP, images, mp4s, video-conferences) composited onto it — **one Pulse instance per source**, the inverse of pexninja's single-instance compositor. | C++ / CMake · built by default |
